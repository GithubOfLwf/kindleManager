...
public class IndexController {
    ...
    public String kindle() {
        return "kindle/product_review_list";
    }

    @GetMapping("/kindle/prouct/sale")
    public String sale() {
        return "kindle/year_review_show";
    }

    @GetMapping("/kindle/rawdata")
    public String rawdata() {
        return "kindle/data_presentation_show";
    }

    @GetMapping("kindle/previewDate")
    public String previewDate(){
        return "kindle/preview_date";
    }
